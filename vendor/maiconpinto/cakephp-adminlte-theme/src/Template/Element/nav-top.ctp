...
<nav class="navbar navbar-static-top" style="background-color: <?php if(!empty($personnalisation) and $personnalisation['nav_color']!=NULL){
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li  class="dropdown user user-menu"><button class="btn btn-warning btn-flat" data-toggle="modal" data-target="#modal-info">
                Aide
              </button></li>
