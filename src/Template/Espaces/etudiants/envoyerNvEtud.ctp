            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form method="post" action="<?php echo $this->Url->build('/etudiants/envoyermsg'); ?>" enctype="multipart/form-data">      <div class="box-body">
                              <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select required class="form-control" name="typeDest"  onChange="top.location.href='<?php echo $this->Url->build('/etudiants/getDestinataire/'); ?>'+this.options[selectedIndex].value">
