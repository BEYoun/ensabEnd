            ...
            <div class="box">
              ...
              ?>
                    ...
                    ?>
                                ...
                                <script>
                                    var srce =
                                        "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsByCne')); ?>";
                                    ...
                                    $('#fltrs').on('change', function () {
                                        ...
                                        switch (mtf) {
                                            ...
                                            case 'nom':
                                                srce =
                                                    "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsByNom')); ?>";
                                                break;
                                            case 'prenom':
                                                srce =
                                                    "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsByPrenom')); ?>";
                                                break;
                                            default:
                                                srce =
                                                    "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsByCne')); ?>";
                ...
                <!-- /.box-header -->
                <form action="/ensab/resposcolarites/preselectione-groupe" method="POST"
                    id="chkPreSelection">
               ...
               ?>
                 ...
                 ?></td>
                                <td class="actions" style="white-space:nowrap">
                                    ...
                                    <?php
                  if ($preinscription['preselection'] == 0) {
                     echo $this->Html->link(__('Ajouter ?'), ['action' => 'AjouterPreinscriptionDef', $preinscription['id']], ['confirm' => __('Confirmer?'), 'class'=>'btn btn-success btn-xs']);
                  }else{
                     echo $this->Form->postLink(__('Candidat ajouté'), ['action' => 'AjouterPreinscriptionDef', $preinscription['id']], ['confirm' => __('Confirmer?'), 'class'=>'btn btn-success btn-xs', 'style'=> 'pointer-events: none;
            ...
            <div class="modal-body">
                <div>
                    <video width="570" height="450" controls="controls" poster="image" preload="true">
                        ...
                        <source src="/ensab/video/administrateur/listePreinscri.webm" type="video/webm">
