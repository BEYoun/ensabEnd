                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <div class="form-body">
                        ...
                        <div class="file-repeater">
                          ...
                          <div data-repeater-item>
                            ...
                            <label class="col-md-3 label-control" for="formationinput1">Module</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="contenuinput3">Semèstre</label>
                          <div class="col-md-9">
                            <input type="text" id="contenuinput3" class="form-control border-primary" placeholder="Semèstre"
                            name="coordonateur">
                    ...
                    <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="departe3">Département</label>
                          <div class="col-md-9">
                            <select class="form-control border-primary" id="departe3" name="departe" >
                              <?php 
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="contenuinput4">Présentation</label>
                          <div class="col-md-9">
