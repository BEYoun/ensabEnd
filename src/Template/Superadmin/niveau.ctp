            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="row-separator-basic-form">Niveaux</h4>
                  ...
                  <div class="card-body">
                    <form class="form form-horizontal row-separator" method="post">
                      <div class="form-body">
                        ...
                        <div class="file-repeater">
                          <div data-repeater-list="niveau">
                          <div data-repeater-item>
                            <div class="form-group row">
                          
                          
                            <label class="col-md-3 label-control" for="formationinput1">Niveau :
                              <span class="danger">*</span> 
                            </label>
                            <div class="col-md-9">
                              <input type="text" id="formationinput1" class="form-control border-primary" placeholder="Libellé de Niveau"
                              name="nom" required>
                            </div>
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="departe3">Filière :
                            <span class="danger">*</span> 
                          </label>
                          <div class="col-md-9">
                            <select class="form-control border-primary" id="departe3" name="fil" required>
                              <?php 
                              
                              
                                foreach ($filieres as $fil) {

                                  echo '<option value="'.$fil['nom'].'">'.$fil['nom'].'</option>';
                    ...
                    <div class="form-group row">
                          <label for="logoUV" class="col-md-3 label-control">
                              ...
                              <div class="col-md-9">
                                <input type="file" accept=".png, .jpg, .jpeg" class="form-control-file" id="logoUV" name="emploi" required>
                              </div>      
                        </div>
                    ...
                    <div class="form-group row last">
                      <div class="col-2 m-auto">
                        ...
                        <button type="button" data-repeater-create class="btn btn-primary">
                          <i class="ft-plus"></i> Ajouter Niveau
                        </button>
                        </div>
                      </div>
                      <br><br>
