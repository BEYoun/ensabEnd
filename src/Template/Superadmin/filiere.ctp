  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true" style="width: auto;">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="service"><i class="la la-cog"></i><span class="menu-title" data-i18n="nav.templates.main">Contrôle <br> d'App</span></a>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="row-separator-basic-form">Départements</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form class="form form-horizontal row-separator" method="post">
                      <div class="form-body">
                        ...
                        <div class="file-repeater">
                          <div data-repeater-list="filiere">
                          <div data-repeater-item>
                            <div class="form-group row">
                          
                          
                            <label class="col-md-3 label-control" for="formationinput1">Filière :
                              <span class="danger">*</span> 
                            </label>
                            <div class="col-md-9">
                              <input type="text" id="formationinput1" class="form-control border-primary" placeholder="Libellé de Filière"
                              name="nom">
                            </div>
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="contenuinput3">Coordonateur de Filière :
                            <span class="danger">*</span> 
                          </label>
                          <div class="col-md-9">
                            <input type="text" id="contenuinput3" class="form-control border-primary" placeholder="Coordonateur de Filière"
                            name="coordonateur">
                    ...
                    <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="departe3">Département :
                            <span class="danger">*</span> 
                          </label>
                          <div class="col-md-9">
                            <select class="form-control border-primary" id="departe3" name="departe" required>
                              <?php 
                              var_dump($refer_depart);
                              $i=0;
                                foreach ($dep_nom as $nom) {

                                  echo '<option value="'.$refer_depart[$i].'">'.$nom.'</option>';
                                  $i++;
                                }
                              ?>
                          </select>
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="contenuinput4">Présentation :
                            <span class="danger">*</span> 
                          </label>
                          <div class="col-md-9">
                            <textarea type="text" id="contenuinput4" class="form-control border-primary" placeholder="Présentation de Filière"
                            name="presentation" rows="4" required></textarea>
                    ...
                    <div class="form-group row last">
                      <div class="col-2 m-auto">
                        ...
                        <button type="button" data-repeater-create class="btn btn-primary">
                          <i class="ft-plus"></i> Ajouter Filière
                        </button>
                        </div>
                      </div>
                      <br><br>
                      ...
                      <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-success float-right" name="save" >
                          Suivant <i class="la la-chevron-circle-right"></i>
                        </button>
                        <br>
                        <br>
