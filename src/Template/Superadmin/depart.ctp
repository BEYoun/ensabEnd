                    ...
                    <form class="form form-horizontal row-separator" method="post">
                      <div class="form-body">
                        ...
                        <div class="file-repeater">
                          <div data-repeater-list="departement">
                          <div data-repeater-item>
                            <div class="form-group row">
                          
                          
                            <label class="col-md-3 label-control" for="formationinput1">Département :
                              <span class="danger">*</span> 
                            </label>
                            <div class="col-md-9">
                              <input type="text" id="formationinput1" class="form-control border-primary" placeholder="Libellé de Département"
                              name="nom" required>
                            </div>
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-md-3 label-control" for="contenuinput3">Chef de Département :
                            <span class="danger">*</span> 
                          </label>
                          <div class="col-md-9">
                            <input type="text" id="contenuinput3" class="form-control border-primary" placeholder="Chef de Département"
                            name="chef" required>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <textarea type="text" id="contenuinput4" class="form-control border-primary" placeholder="Présentation de département"
                    ...
                    <div class="form-group row last">
                      <div class="col-2 m-auto">
                        ...
                        <button type="button" data-repeater-create class="btn btn-primary">
                          <i class="ft-plus"></i> Ajouter Département
                        </button>
                        </div>
                      </div>
                      <br><br>
