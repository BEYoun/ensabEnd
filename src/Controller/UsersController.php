        ...
        if ($this->request->is('post')){
            ...
            if($user){
               ...
               // $this->Flash->success('Connexion avec succes');
                ...
                {
                    case 'superadmin':
                        return $this->redirect(array('controller' => 'Superadmin', 'action' => 'home'));
                        break;
                    case 'directeur':
                        return $this->redirect(array('controller' => 'Directeur', 'action' => 'index'));
                        break;
                    case 'admin':
                    ...
                    case 'resposcolarite':
                        ...
                        $session->write('nom_user', "Responsable du Scolarité");
