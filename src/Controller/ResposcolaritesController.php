...
class resposcolaritesController extends AppController {
    ...
    public function beforeFilter(Event $event)
    {
        ...
        if($usrole!='resposcolarite' && $usrole!='admin' && $usrole != 'directeur')
        {
    ...
    public function index() {
        ...
        $usrole = $this->Auth->user('role');
        if($usrole=='resposcolarite' || $usrole == 'directeur') {
            if($usrole=='resposcolarite' || $usrole == 'directeur') {
    ...
    public function edit2($id=null)
    {
        ...
        if(isset($_POST['code']))
        {
            ...
            // var_dump($id_ele);
            // var_dump($id_se);
            // var_dump($this->request->data['profp']);
            // die();
            if(isset($this->request->data['profp']))
            {
                $id_pro = $this->request->data['profp'];
...
$connection = ConnectionManager::get('default');
    ...
    public function preselectioneGroupe()
    {
        ...
        if($this->request->data['ListPreselecione']!=null){
